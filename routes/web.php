...
//test
    ...
    Route::get('/fix-muaythai-script', 'LoginController@muaythaiScheduleFixing')->name('fix-muaythai-script');
...
//    Route::get('courses/{courseName}', 'CourseController@index')->name('courses');
    ...
    Route::get('private/edit/{private}', 'TransactionPrivateHeaderController@edit')->name('transactions.private.edit');
...
Route::get('/select-courses-extended-day', 'Admin\CourseController@getExtendedCoursesDay')->name('select.extended_day.courses');
Route::get('/select-courses-with-type', 'Admin\CourseController@getCourseWithType')->name('select.type.courses');
