...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            {{ Form::open(['route'=>['admin.attendances.show-report'],'method' => 'post','id' => 'general-form','class'=>'form-horizontal form-label-left']) }}
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="date" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('end_date')) parsley-error @endif"
                           name="date" value="{{ old('end_date') }}">
                </div>
            </div>
