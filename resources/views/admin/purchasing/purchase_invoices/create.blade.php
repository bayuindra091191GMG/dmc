                            ...
                            @if(!empty($purchaseOrder))
                                @foreach($purchaseOrder->purchase_order_details as $detail)
                                    ...
                                    <tr class='item{{ $idx }}'>
                                        ...
                                        <td>
                                            <input type='text' name='price[]' class='form-control' value='{{ $detail->price_string }}' readonly/>
                                        </td>
                                        <td>
                                            <input type='text' name='discount[]' class='form-control' value='{{ $detail->discount }}' readonly/>
                                        </td>
                                        <td>
                                            <input type='text' name='subtotal[]' class='form-control' value='{{ $detail->subtotal_string }}' readonly/>
                                        </td>
                                        <td>
                                        ...
                                        <td class='text-center'>
                                            ...
                                            <a class="edit-modal btn btn-info" data-id="{{ $idx }}" data-item-id="{{ $itemId }}" data-item-text="{{ $detail->item->code. ' - '. $detail->item->name }}" data-qty="{{ $detail->quantity }}" data-remark="{{ $detail->remark }}" data-price="{{ $detail->price }}" data-discount="{{ $detail->discount }}">
                                                <span class="glyphicon glyphicon-edit"></span>
                                            </a>
                                            <a class="delete-modal btn btn-danger" data-id="{{ $idx }}" data-item-id="{{ $itemId }}" data-item-text="{{ $detail->item->code. ' - '. $detail->item->name }}" data-qty="{{ $detail->quantity }}" data-price="{{ $detail->price }}" data-discount="{{ $detail->discount }}">
