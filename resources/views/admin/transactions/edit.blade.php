    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="registration_fee" name="registration_fee" type="text" class="form-control col-md-7 col-xs-12" value="{{ $header->registration_fee }}">
                </div>
            </div>
                        ...
                        <table class="table table-bordered table-hover" id="detail_table">
                            ...
                            @foreach($header->transaction_details as $detail)
                                <tr class="item{{ $detail->id }}">
                                    ...
                                    <td class="text-right">{{ $detail->discount_string }}</td>
