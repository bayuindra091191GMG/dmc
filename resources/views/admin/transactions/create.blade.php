...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $('.modal-footer').on('click', '.add', function() {
            $('#detailTable').append("<tr class='item" + $('select[name=course_add]').val() + "' align='center'>" +
                ...
                "<td><span class='delete-modal btn btn-danger'><span class='glyphicon glyphicon-trash'></span></span></td></tr>");
