...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
            <h2>Buat Transaksi Private Baru</h2>
            <hr/>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            {{ Form::open(['route'=>['admin.transactions.private.store'],'method' => 'post','id' => 'general-form','class'=>'form-horizontal form-label-left']) }}
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $('#customer').on('select2:select', function (e) {
            ...
            window.location.replace('/admin/private/create?customer=' + data.id);
        });
        ...
        $('.modal-footer').on('click', '.add', function() {
            ...
            sbAdd.append("<td class='text-center'>" + meetingAdd + "<input type='hidden' name='meeting_amount[]' value='" + meetingAdd + "'/></td>");
