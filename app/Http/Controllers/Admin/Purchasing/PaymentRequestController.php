...
class PaymentRequestController extends Controller
{
    ...
    public function printDocument($id){
        ...
        $terbilang = $this->terbilang($paymentRequest->total_amount);

        return view('documents.payment_requests.payment_requests_doc', compact('paymentRequest', 'poDetails', 'piDetails', 'terbilang'));
    }
